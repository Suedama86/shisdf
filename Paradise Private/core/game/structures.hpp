...
enum Offset
{
	...
	CurrentVehicle = 0x2a10,
	bAlreadySearched = 0xd9a,
	BoneArray = 0x580,
	BoneArrayCache = 0x5b8,
	LocalPlayers = 0x38,
	OwningWorld = 0xc0,
	...
	Tier = 0xa2,
	AActors = 0xA0,
	PrimaryPickupItemEntry = 0x348,
	LocationUnderReticle = 0x2700,
	Mesh = 0x328,
	PlayerState = 0x2c8,
	RootComponent = 0x1b0,
	CurrentWeapon = 0x9f8,
	...
	TeamIndex = 0x1239,
	NameStructure = 0xad0,
	BuildingState = 0x1ee8,
	ComponentToWorldUpdated = 0x180,
	...
	WeaponData = 0x568,
	Parent = 0x100,
	ProjectileSpeed = 0x1f60,
	ProjectileGravity = 0x1f64,
	WeaponCoreAnimation = 0x14d8,
	ItemName = 0x40,
	PlayerArray = 0x2c0,
	AmmoCount = 0xfac,
	PawnPrivate = 0x320,
	HabaneroComponent = 0xa10,
	RankInformation = 0xb8,
...
public:
	...
	auto OnScreen( ) -> bool
	{
		return ( this->x > 0 && this->x < jrt::screen.fWidth && this->y > 0 && this->y < jrt::screen.fHeight );
	}
};
...
constexpr std::array<std::pair<EBoneIndex, EBoneIndex>, 16> eBonePairs =
{
	{ { EBoneIndex::Neck, EBoneIndex::Child },
	...
	{ EBoneIndex::RFoot, EBoneIndex::RFootL },
	{ EBoneIndex::LFoot, EBoneIndex::LFootR },
	{ EBoneIndex::HeadFoot, EBoneIndex::Head },
	{ EBoneIndex::MShoulder, EBoneIndex::RHip },
	{ EBoneIndex::MShoulder, EBoneIndex::LHip } },
};
